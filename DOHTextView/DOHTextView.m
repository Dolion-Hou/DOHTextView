...
- (void)setMinNumberOfWords:(NSInteger)minNumberOfWords{
    _minNumberOfWords = minNumberOfWords;
    if (_minNumberOfWords>0) {
        self.isAllow = NO;
        self.handleTip = @"请输入您宝贵的意见";
    }else{
        self.isAllow = YES;
    }
}
